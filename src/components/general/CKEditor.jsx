...
export default function App({ value, onChange }) {
    ...
    initialData: value || '',  // Set initial value to the one passed as prop or empty
		placeholder: 'Buat artikelnya disini',
		heading: {
			options: [
				{
					model: 'paragraph',
						...
						<div ref={editorRef}>
							{isLayoutReady && (
								<CKEditor
									...
									config={editorConfig}
									data={value}  // Set current value
									onChange={(event, editor) => {
										const data = editor.getData();
										onChange(data);  // Call the onChange function passed as a prop
									}}
								/>
							)}
						</div>
